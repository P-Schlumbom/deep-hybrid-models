"""
Shamelessly copied from https://github.com/jhjacobsen/invertible-resnet/blob/master/spectral_norm_conv_inplace.py
...
class SpectralNormConv(object):
    ...
    def __init__(self, coeff, input_dim, name='weight', n_power_iterations=1, eps=1e-12):
        #print(coeff, input_dim, name, n_power_iterations, eps)
        self.coeff = coeff
    ...
    def compute_weight(self, module, do_power_iteration):
        ...
        #print(weight.shape, u.shape, v.shape)
        ...
        output_padding = 0
        if stride[0] > 1 and self.input_dim[2] % 2 == 0:
            output_padding = 1
        ...
        if do_power_iteration:
            with torch.no_grad():
                for _ in range(self.n_power_iterations):
                    ...
                    #print("u.view: ", u.view(self.out_shape).shape)
                    #print(weight.shape, stride, padding)
                    ...
                    #print(v.shape, self.input_dim)
                    #print(v.view(self.input_dim).shape)
