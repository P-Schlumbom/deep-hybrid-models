"""
shamelessly copied from https://github.com/jhjacobsen/invertible-resnet/blob/630e886bcd50cc21dee0769d1a5b35100d3ff569/spectral_norm_fc.py
"""
...
class SpectralNorm(object):
    ...
    def __init__(self, coeff, name='weight', n_power_iterations=1, dim=0, eps=1e-12):
        ...
        self.name = name
        self.dim = dim
        #if n_power_iterations <= 0:  # let me do 0 iterations >:(
